# javascheduling Project
This project takes a series of talks for Java Conf 2020 from the file input.text 
...
You can then execute your native executable with: `./target/javascheduling-1.0-SNAPSHOT-runner`
